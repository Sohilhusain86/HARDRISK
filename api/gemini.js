...
module.exports = async function handler(req,res){
  ...
  try{
    ...
    const proxyReq={...req,body:{task:'gemini_compatibility',prompt:combined,systemInstruction:'You are Suhail AI, an educational assistant. Answer accurately in simple Hindi/Urdu/English as appropriate.'}};
    return chatHandler(proxyReq,res);
  }catch(e){console.error(e);return res.status(500).json({error:'AI compatibility route failed.'});}
};
